...
VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9)
RETURNING id, sweetness, body, tannin, acidity, wine_style, varietal, region, vintage, winery, created_at, updated_at
`
...
SELECT id, sweetness, body, tannin, acidity, wine_style, varietal, region, vintage, winery, created_at, updated_at FROM wine_post_details WHERE id = $1
`
